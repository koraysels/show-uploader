...
import ShowStatusView, { useShowStatuses } from '../components/ShowStatus';
...
export default function Attach() {
  ...
  // Nothing on this list is archived yet by definition, so an upload row here
  // only ever means work in flight — never "already uploaded".
          ...
          {eligible.map((s) => (
            ...
            >
              ...
              >
                ...
                <ShowStatusView status={statusFor(s.id, { archived: false })} variant="inline" />
              </Stack>
